...
/// Sometimes this can also lead to faster implementations than an analytical
/// derivative. The main advantage though, is being able to express the equation once
/// in a natural format.
